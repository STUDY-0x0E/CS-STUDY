...
4. **발표 및 질의응답**: 각 참여자는 5분 동안 주제에 대한 발표를 진행하고, 이어서 5분 동안 질문과 응답을 진행합니다.
5. **질의응답 리뷰**: 지난 주에 미해결된 질문들에 대한 정확한 답변을 제공합니다.
...
- 발표 자료는 Markdown(.md) 파일뿐만 아니라 다른 형식의 파일을 사용해도 됩니다.
